...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "relative inline-flex h-10 items-center justify-center rounded-md bg-secondary p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
  ...
  >
    {isActive && (
      <motion.div
        ...
        className="absolute inset-0 rounded-sm bg-primary shadow-sm"
