...
export function GoogleIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" {...props}>
            ...
            <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 7.585l6.19 5.238C42.011 35.794 44 30.138 44 24c0-1.341-.138-2.65-.389-3.917"></path>
        </svg>
    );
}
